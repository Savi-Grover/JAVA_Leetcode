...
Compelling reasons for using nested classes include the following:
	...
	2. It increases encapsulation: Consider two top-level classes, A and B, where B needs access
...
Visibility modifiers (public, private and protected) effect whether the nested class definition is accessible beyond the
outer class definition. 

For example, a private nested class can be used by the outer class, but by
no other classes.
*/
/*
Let us take example of LinkedList and Tree class. Both the linked list and tree have nodes to store
new element. Both the linked list and tree have their nodes different, so it is best to declare their
corresponding nodes class inside their own class to prevent name conflict and increase
encapsulation.
